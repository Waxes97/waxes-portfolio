...
<section id="contact" className="py-32 px-6 relative overflow-hidden">
  ...
  <div className="max-w-5xl mx-auto bg-[#131316] rounded-[4rem] p-12 md:p-24 text-center border border-white/5 shadow-2xl relative overflow-hidden">
    ...
    <span>Payments accepted: <span className="text-red-600">only via <span className="text-green-600">Bank Transfer</span> or <span className="text-blue-600">Paypal</span></span></span>
    </p>
